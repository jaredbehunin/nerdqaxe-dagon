...
protected:
    ...
    // Dagon sigil side groups (plain digital readouts, updated live)
    lv_obj_t *ui_lbSigPower = nullptr;
    lv_obj_t *ui_lbSigFreq = nullptr;
    lv_obj_t *ui_lbSigVcore = nullptr;
    lv_obj_t *ui_lbSigAccepted = nullptr;
    lv_obj_t *ui_lbSigRejected = nullptr;
    lv_obj_t *ui_lbSigBlocks = nullptr;
