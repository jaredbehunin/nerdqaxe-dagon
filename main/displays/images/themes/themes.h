...
// image files for theme Dagon (Mehrunes Dagon, 480x320 big-screen variant)
LV_IMG_DECLARE(ui_img_Dagon_miningscreen2_png);
LV_IMG_DECLARE(ui_img_Dagon_generic_png);

// class for theme Dagon -- full mining art; generic bg reused for other screens
class ThemeDagon : public Theme {
public:
    ThemeDagon() {
        setMiningscreen2(&ui_img_Dagon_miningscreen2_png);
        setInitscreen2(&ui_img_Dagon_generic_png);
        setSplashscreen2(&ui_img_Dagon_generic_png);
        setPortalscreen(&ui_img_Dagon_generic_png);
        setBtcscreen(&ui_img_Dagon_generic_png);
        setSettingsscreen(&ui_img_Dagon_generic_png);
        setGlobalstats(&ui_img_Dagon_generic_png);
    }
};
