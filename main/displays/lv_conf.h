...
/* big-screen 480x320 ST7796 on 8-bit parallel needs the bytes swapped (smooth
 * gradients showed rainbow banding otherwise). Theme images are encoded big-endian to match. */
